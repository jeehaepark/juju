...
router.post('/api/v1/watcheditems', function(req, res) {
    ...
    var data = {deadline: req.body.deadline, 
...
router.put('/api/v1/watchedItems/:user_id', function(req, res) {
    ...
    // Grab data from http request
    var data = {deadline: req.body.deadline, idealPrice: req.body.idealPrice, settlePrice:req.body.settlePrice, priceReached:req.body.priceReached,
                emailed: req.body.emailed,
                itemID: req.body.itemID,
                userID: req.body.userID};
