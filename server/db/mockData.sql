...
INSERT INTO `watchedItems` (`deadline`,`idealPrice`,`settlePrice`,`priceReached`,`emailed`,`itemID`,`userID`) VALUES ('04-01-2016', 7000, 8000, 1, 1, 1, 1);
INSERT INTO `watchedItems` (`deadline`,`idealPrice`,`settlePrice`,`priceReached`,`emailed`,`itemID`,`userID`) VALUES ('04-01-2016', 8000, 8500, 0, 0, 2, 1);
